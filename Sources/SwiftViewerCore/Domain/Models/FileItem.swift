...
public struct FileItem: Identifiable, Hashable, Sendable {
    ...
    public init(url: URL, isDirectory: Bool, isAvailable: Bool = true, uuid: UUID? = nil, colorLabel: String? = nil, isFavorite: Bool? = nil, flagStatus: Int16? = nil, fileCount: Int? = nil, creationDate: Date? = nil, modificationDate: Date? = nil, fileSize: Int64? = nil, orientation: Int? = nil) {
        self.url = url
