...
public struct AdvancedCopyView: View {
    ...
    public var body: some View {
        ...
        .onChange(of: viewModel.organizeByDate) { _, _ in viewModel.updatePreview() }
    ...
    private var leftPane: some View {
        VStack {
            Text("Source")
                .font(.subheadline)
                .padding(.top, 8)
            SimpleFolderTreeView(rootFolders: viewModel.sourceRootFolders, selectedFolder: $viewModel.selectedSourceFolder, expandedFolders: $viewModel.expandedSourceFolders, viewModel: viewModel)
