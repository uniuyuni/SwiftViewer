...
final class UIConsistencyTests: XCTestCase {
    ...
    override func tearDownWithError() throws {
        let exp = expectation(description: "Wait for background tasks")
    ...
    func testSelectionPreservationAfterUpdate() async throws {
        ...
        let data = Data(base64Encoded: "" )!
        try data.write(to: jpg1URL, options: .atomic)
        try data.write(to: jpg2URL, options: .atomic)
